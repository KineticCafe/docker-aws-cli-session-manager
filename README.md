...
(`kineticcafe/aws-cli-session-manager:2.22.34`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.22.34`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.22.34` by
...
```sh
$ AWS_CLI_VERSION=2.22.34 ./aws-cli-session-manager --version
