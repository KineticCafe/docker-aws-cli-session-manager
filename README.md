...
(`kineticcafe/aws-cli-session-manager:2.17.62`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.17.62`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.17.62` by
...
```sh
$ AWS_CLI_VERSION=2.17.62 ./aws-cli-session-manager --version
