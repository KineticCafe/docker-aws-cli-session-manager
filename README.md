...
(`kineticcafe/aws-cli-session-manager:2.23.2`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.23.2`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.23.2` by
...
```sh
$ AWS_CLI_VERSION=2.23.2 ./aws-cli-session-manager --version
