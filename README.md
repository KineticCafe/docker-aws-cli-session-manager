...
(`kineticcafe/aws-cli-session-manager:2.17.28`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.17.28`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.17.28` by
...
```sh
$ AWS_CLI_VERSION=2.17.28 ./aws-cli-session-manager --version
