...
(`kineticcafe/aws-cli-session-manager:2.17.18`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.17.18`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.17.18` by
...
```sh
$ AWS_CLI_VERSION=2.17.18 ./aws-cli-session-manager --version
