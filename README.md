...
(`kineticcafe/aws-cli-session-manager:2.22.23`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.22.23`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.22.23` by
...
```sh
$ AWS_CLI_VERSION=2.22.23 ./aws-cli-session-manager --version
