...
(`kineticcafe/aws-cli-session-manager:2.22.18`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.22.18`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.22.18` by
...
```sh
$ AWS_CLI_VERSION=2.22.18 ./aws-cli-session-manager --version
