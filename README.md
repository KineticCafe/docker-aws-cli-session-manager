...
(`kineticcafe/aws-cli-session-manager:2.18.16`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.18.16`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.18.16` by
...
```sh
$ AWS_CLI_VERSION=2.18.16 ./aws-cli-session-manager --version
