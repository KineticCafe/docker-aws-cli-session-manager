...
(`kineticcafe/aws-cli-session-manager:2.17.42`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.17.42`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.17.42` by
...
```sh
$ AWS_CLI_VERSION=2.17.42 ./aws-cli-session-manager --version
