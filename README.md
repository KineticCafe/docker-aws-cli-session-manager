...
(`kineticcafe/aws-cli-session-manager:2.17.47`) or GitHub Container Registry
(`ghcr.io/kineticcafe/aws-cli-session-manager:2.17.47`).
...
It will pull from `ghcr.io/kineticcafe/aws-cli-session-manager:2.17.47` by
...
```sh
$ AWS_CLI_VERSION=2.17.47 ./aws-cli-session-manager --version
